...
<div id="pwdorpassphrase">
    ...
    <div class="remote-key" style="display:none;">
        ...
        <div class="form-group">
            ...
            <sup><a href="#" class="bt_reformatSSHKey"><i class="fas fa-play-circle icon_orange tooltips" title="{{Cliquez ici pour formater la clé SSH en blocs de 64 caractères}}"></i></a></sup>
            </label>
            <div class="col-md-8">
